...
export function FingerprintDiagram() {
  return (
...
/** Progression, not a threat: free tools -> free app -> Pro. */
...
/** Looks up the motif by id (lib/visuals `Diagram` type). The `pro` prop is
 * accepted for call-site compatibility and ignored: it used to draw a red X
 * "cut mark", which read as an error rather than as protection. */
export function Diagram({ id }: { id: DiagramId; pro?: boolean }) {
