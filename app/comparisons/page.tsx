...
export default function ComparisonsIndex() {
  ...
  const items = getAllContentItems<ComparisonMeta & EditableContent>('comparisons').filter(isPublished);
  ...
  return (
    <div>
      <PageHero
        ...
        kicker="Comparisons"
        title="Privacy comparisons"
        description="Side-by-side comparisons to help you choose the right privacy tools for your needs."
