...
const RULES: Array<[RegExp, SiteCategory]> = [
  ...
  // Whole words only: "love", "date" and "match" filed ilovepdf.com (a PDF
  // tool) under Dating, and would take any "update" or "matchbox" host with it.
  [/dating|singles/, 'dating'],
